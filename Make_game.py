...
# 캐릭터의 스탠딩 모션
character_standing_Left = [pygame.image.load("C:/Users/tlseh/OneDrive/문서/GitHub/Making game/2DGP Game Source File/Character_Standing/character_standing 1.png"),
