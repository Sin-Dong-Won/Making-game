...
bg_bb_start_x = 64
bg_bb_start_y = 420
bg_width = load.background1_size.width - bg_bb_start_x * 3
...
class Map:
    def __init__(self):
        self.x = 0
        self.y = 0
        self.image = pygame.image.load("2DGP Game Source File/Map/Shop_Map.png")
    ...
    def get_out_box(self):
        return [self.x + bg_bb_start_x, self.y + bg_bb_start_y, bg_bb_start_x * 2, bg_height]

    def get_clear_box(self):
        return [bg_width - bg_bb_start_x, self.y + bg_bb_start_y, bg_bb_start_x * 2, bg_height]
